...
nlsave('Silicon_PBE_band_results.hdf5', calculator)
...
nlsave('Silicon_PBE_band_results.hdf5', silicon_pbe_opt_results_bulk_configuration_1)
...
nlsave('Silicon_PBE_band_results.hdf5', bandstructure)
